...
- **Quattro lingue** (Italiano, Deutsch, English, Français) con selettore in alto
  a destra; la scelta viene ricordata nel browser.
...
| `i18n.js`      | Traduzioni IT/DE/EN/FR e nomi delle carte        |
