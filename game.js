...
const SIMBOLO = { denari: "♦", coppe: "♥", spade: "♠", bastoni: "♣" };
...
function cartaHTML(c, classi = "") {
  ...
  return `<div class="carta ${c.seme}${sett} ${classi}" data-id="${c.id}">
      <div class="valore">${et}</div>
      <div class="seme-big">${SIMBOLO[c.seme]}</div>
